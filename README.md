...
- - `skills/kmp-migration/references/configurations.md` — variant structures for native UI (e.g. SwiftUI on iOS) and server-included projects
  ...
  - ```bash
    ...
    > **Note:** `SKILL.md` is an open standard — the skill works across all compatible agents. The only difference between tools is the installation path.
    >
    > ## Covered scenarios
    >
    ...
    >           - - [KMP wizard](https://kmp.new)# kmp-migration-skill
...
- `SKILL.md` — main migration guide with step-by-step instructions for each module
- `references/configurations.md` — variant structures for native UI (e.g. SwiftUI on iOS) and server-included projects

## Installation

Download `kmp-migration.skill` and install it in Claude via **Settings → Skills**.
